...
catch_me_if_you_can = media.Movie("Catch Me If You Can <br>(2002)", 8,
...
shawshank_redemption = media.Movie("Shawshank Redemption <br>(1994)", 9,
...
the_intern = media.Movie("The Intern <br>(2015)", 7,
...
the_newsroom = media.Tvshow("The Newsroom",
                            "A behind-the-scenes look at the people who make a nightly cable-news program. "
                            "Focusing on a network anchor, his new executive producer, the newsroom staff, and their boss,"
                            "the series tracks their quixotic mission to do the news well in the face of corporate and "
                            "commercial obstacles-not to mention their own personal entanglements.",
                            "http://cdn-static.sidereel.com/tv_shows/52629/giant_2x/256227-8.jpg",
